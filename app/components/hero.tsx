  ...
  return (
    <div className="w-full 1000px:flex items-center">
      ...
      <div className="1000px:w-[40%] flex 1000px:min-h-screen items-center justify-end pt-[70px] 1000px:pt-[0] z-10">
        <Image alt="hero image" src={require("../../public/images/hero2.png")} />
      </div>
      <div className="1000px:w-[60%] flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left mt-[150px]">
        <h2 className="dark:text-white text-[#000000c7] text-[25px] px-3 w-full 1000px:text-[70px] font-[600] font-Josefin py-2 1000px:leading-[75px] 1500px:w-[60%] ">
          Improve Your Online Learning Experiance Better Instantly
        </h2>
        <br />
        ...
        <br />
        <br />
        <div className="1500px:w-[55%] 1100px:w-[78%] w-[90%] felx items-center">
          <Image
